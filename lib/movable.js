...
Movable.prototype.translate = function translate(values, time) {
...
Movable.prototype.scale = function scale(values, time) {
    if (time) { // tween/animate
        var self = this,
            aux = [0, 0];
...
Movable.prototype.rotate = function rotate(values, time) {
    if (time) { // tween/animate
        var self = this;
